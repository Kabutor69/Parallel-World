      ...
      options: [
        {
          ...
          options: [
            ...
            {
              name: "image1",
              description: "First image to include",
              type: 11,
              required: false,
            },
            {
              name: "image2",
              description: "Second image to include",
              type: 11,
              required: false,
            },
            {
              name: "image3",
              description: "Third image to include",
              type: 11,
              required: false,
            },
            {
              name: "image4",
              description: "Fourth image to include",
              type: 11,
              required: false,
            },
            {
              name: "image5",
              description: "Fifth image to include",
              type: 11,
              required: false,
            },
          ],
